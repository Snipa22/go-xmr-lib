...
func GetBlockHeaderByHeight(ctx context.Context, id int) (BlockHeader, error) {
	...
	if resp.StatusCode < 200 || resp.StatusCode >= 300 {
		...
		return BlockHeader{}, fmt.Errorf("xmr daemon rpc: get_block_header_by_height returned HTTP %d: %s", resp.StatusCode, body)
	}
